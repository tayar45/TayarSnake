...
snakeHead.src='/images/snakeBody.jpg'
const snakeBodyImage = new Image();
snakeBodyImage.src='/images/snakeBody.jpg'
...
left.ontouchend=function(){
  if (moveX==0) {
    moveX=-1
    moveY=0
    snakeHead.src='/images/snakeLeft.jpg'
  }
}
right.ontouchend = function() {
    if (moveX ==0) {
      moveX = 1
      moveY = 0
      snakeHead.src='/images/snakeRight.jpg'
    }
...
down.ontouchend=function (){
  if (moveY==0) {
    moveX=0
    moveY=1
    snakeHead.src='/images/snakeDown.jpg'
  }
}
...
up.ontouchend = function() {
    if (moveY == 0) {
      moveX = 0
      moveY = -1
      snakeHead.src='/images/snakeUp.png'
    }
}
